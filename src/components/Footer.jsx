// src/components/Footer.jsx (versión con logo de imagen)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <Link to="/" className="inline-block mb-4">
              <img 
                src="/assets/logos/logo-vitccel.png" 
                alt="Logo de Vitccel"
                className="h-24" 
              />
            </Link>
            ...
            <div className="flex mt-6">
              <a 
                href="https://www.instagram.com/vitccel/" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Instagram" 
                className="bg-white/10 hover:bg-[#06A3DA] transition-colors p-2 rounded-full"
              >
                <InstagramIcon />
              </a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><Link to="/servicios/licencias" className="hover:text-[#06A3DA] transition-colors">Licenciamiento</Link></li>
              <li><Link to="/servicios/soporte" className="hover:text-[#06A3DA] transition-colors">Soporte de TI</Link></li>
            </ul>
          </div>
